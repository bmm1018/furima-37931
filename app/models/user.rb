class User < ApplicationRecord
  ...
  devise :database_authenticatable, :registerable,
         :recoverable, :rememberable, :validatable
          ...
          validates :first_name, presence: true, format: {with: /\A[ぁ-んァ-ヶ一-龥]/, message: "is invalid. Input full-width characters"}
          validates :last_name, presence: true, format: {with: /\A[ぁ-んァ-ヶ一-龥]/, message: "is invalid. Input full-width characters"}
